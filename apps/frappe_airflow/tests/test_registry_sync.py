...
from frappe_airflow.airflow_db.registry_sync import build_registry, rebuild_client_registry
...
def test_rebuild_calls_set_variable():
    with patch("frappe_airflow.airflow_db.registry_sync.set_variable") as mock_set:
