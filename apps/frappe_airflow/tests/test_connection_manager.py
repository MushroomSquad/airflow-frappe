...
def test_list_connections_returns_list():
    ...
    with patch("frappe_airflow.airflow_db.connection_manager.get_session", return_value=cm):
        from frappe_airflow.airflow_db.connection_manager import list_connections
...
def test_upsert_encrypts_password():
    ...
    from frappe_airflow.airflow_db.fernet import decrypt
...
def test_get_connection_decrypts_password():
    from frappe_airflow.airflow_db.fernet import encrypt
